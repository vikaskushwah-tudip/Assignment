...
public class Database
{
    ...
    public void addCustomer(int newID, String newPassward, String newFirstName, String newLastName) throws DatabaseException
    {
        Customer newCustomer;

            newCustomer = new Customer(newID, newLastName, newFirstName, newPassward);
    ...
    ***************************************************************************/
    ...
    private void loadCustomerFile() throws DatabaseException
    {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(CUSTOMER_FILE));
            String line = reader.readLine();
            ...
            while (line != null) {
                ...
                // Add the data from file to the registerCourses array list
                Customer customer = new Customer(Integer.parseInt(id),lastName, firstName, password);
